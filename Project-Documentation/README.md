...
[Housing Permits]()
- [Permit Geocode]()
- [Housing Database Schema](https://github.com/BayAreaMetro/DataServices/Project-Documentation/hsngDBSchema.md) - Schemas for the tables comprising the housing database.
